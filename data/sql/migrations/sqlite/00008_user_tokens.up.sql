-- 00008_user_tokens.up.sql (SQLite version)
...
ALTER TABLE password_reset ADD COLUMN jti TEXT;
ALTER TABLE password_reset ADD COLUMN issued_at TIMESTAMP;
ALTER TABLE password_reset ADD COLUMN expires_at TIMESTAMP;
ALTER TABLE password_reset ADD COLUMN used_at TIMESTAMP;
ALTER TABLE password_reset ADD COLUMN scope_tenant_id TEXT;
ALTER TABLE password_reset ADD COLUMN scope_org_id TEXT;
